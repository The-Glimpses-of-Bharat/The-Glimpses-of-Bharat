...
const seed = async () => {
  try {
    ...
    const fightersCount = await Fighter.countDocuments();
    if (fightersCount === 0) {
      ...
      console.log("Sample freedom fighters added to database.");
    } else {
      console.log("Database already contains freedom fighters.");
    }
